...
\title{Supplementary Materials for ``The benefits of ambitious short-term targets when decarbonising the sector-coupled energy system in Europe'' }
...
\caption{Evolution of the electricity generation mix in every country for the Tortoise transition path.} \label{fig_primary_energy} 
\end{figure*}
...
\caption{Evolution of technologies used to supply heating in residential and services sector in the Tortoise path. } \label{fig_heating_shares} 
\end{figure}
