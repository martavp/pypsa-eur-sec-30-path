...
def plot_co2_prices():
    ...
    ax1.plot(date2, [20, 47, 72, 114, 220, 336, 394], linewidth=2, color= 'gold', 
         marker='o', markerfacecolor='white', label='cautious')
    ax1.plot(date2, [20, 33, 67, 219, 413, 375, 365], linewidth=2, 
         color= 'firebrick', marker='o', markerfacecolor='white', label='last-minute')
