...
\begin{figure*}[!h]
\centering
\includegraphics[width=0.6\textwidth]{figures/age_distribution.png}
...
\begin{figure*}[!h]
\centering
\includegraphics[width=0.6\textwidth]{figures/heating_expansion.png}
...
\textcolor[rgb]{1,0,0}{TODO: Write paragraph discussing the country-specific mix of primary energy and reference previous results regarding balancing. Add reference to MGA results. Add figure with Fourier power spectra. 
Discuss also the difference between the 2050 results with the cautious path and using greenfield optimization, using the spatial plot figure in the Supplementary Materials.}
