...
\begin{figure*}[!h]
\centering
\includegraphics[width=14cm]{figures/electricity_production_go.png}
\caption{Evolution of electricity mix in every country for the transition path cautious.} \label{fig_primary_energy} 
\end{figure*}
